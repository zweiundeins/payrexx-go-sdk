...
// APIClient manages communication with the Payrexx REST API API v1.16
...
type APIClient struct {
	...
	BillAPI *BillAPIService

	EcrAPI *EcrAPIService

	GatewayAPI *GatewayAPIService

	InvoiceAPI *InvoiceAPIService

	PaymentProviderAPI *PaymentProviderAPIService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.BillAPI = (*BillAPIService)(&c.common)
	c.EcrAPI = (*EcrAPIService)(&c.common)
	c.GatewayAPI = (*GatewayAPIService)(&c.common)
	c.InvoiceAPI = (*InvoiceAPIService)(&c.common)
	c.PaymentProviderAPI = (*PaymentProviderAPIService)(&c.common)
