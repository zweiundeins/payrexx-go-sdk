...
// checks if the GatewayCreateRequestFields type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GatewayCreateRequestFields{}

// GatewayCreateRequestFields The contact data fields which should be stored along with payment
type GatewayCreateRequestFields struct {
	...
	CustomField1  *GatewayCreateRequestFieldsCustomField1 `json:"custom_field_1,omitempty"`
...
func NewGatewayCreateRequestFields() *GatewayCreateRequestFields {
	this := GatewayCreateRequestFields{}
	return &this
}
...
func (o *GatewayCreateRequestFields) GetCustomField1() GatewayCreateRequestFieldsCustomField1 {
	if o == nil || IsNil(o.CustomField1) {
		var ret GatewayCreateRequestFieldsCustomField1
		return ret
	}
...
// SetCustomField1 gets a reference to the given GatewayCreateRequestFieldsCustomField1 and assigns it to the CustomField1 field.
...
func (o GatewayCreateRequestFields) MarshalJSON() ([]byte, error) {
...
func (o GatewayCreateRequestFields) ToMap() (map[string]interface{}, error) {
...
type NullableGatewayCreateRequestFields struct {
	value *GatewayCreateRequestFields
	isSet bool
}

func (v NullableGatewayCreateRequestFields) Get() *GatewayCreateRequestFields {
	return v.value
}

func (v *NullableGatewayCreateRequestFields) Set(val *GatewayCreateRequestFields) {
	v.value = val
	v.isSet = true
}

func (v NullableGatewayCreateRequestFields) IsSet() bool {
	return v.isSet
}

func (v *NullableGatewayCreateRequestFields) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGatewayCreateRequestFields(val *GatewayCreateRequestFields) *NullableGatewayCreateRequestFields {
	return &NullableGatewayCreateRequestFields{value: val, isSet: true}
}

func (v NullableGatewayCreateRequestFields) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGatewayCreateRequestFields) UnmarshalJSON(src []byte) error {
	v.isSet = true
